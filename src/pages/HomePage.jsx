      ...
      <div className='w-full max-w-screen font-display bg-background'>
        <div className='w-full bg-white'>
            ...
            <div className='flex flex-col items-center md:flex-row md:px-30'>
                <h1 className='flex items-center mb-10 px-8 text-4xl font-bold text-start w-85 h-60 rounded-2xl bg-gradient-to-t from-pink-400 via-pink-200 to-salmon-400 text-white '>Check out our most popular courses!</h1>
