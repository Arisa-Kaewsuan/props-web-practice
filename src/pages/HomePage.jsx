      ...
      <div className='w-full max-w-screen font-display bg-background'>
        <div className='w-full bg-white'>
            ...
            <div className='flex flex-col items-center md:flex-row md:px-30'>
              ...
              <CourseCards icon=".\src\assets\icon-run.svg" title="Animation" describe="Learn the latest animation techniques to create stunning motion design and captivate your audience."/>
              <CourseCards icon=".\src\assets\icon-img.svg" title="Design" describe="Create beautiful, usable interfaces to help shape the future of how the web looks."/>
            </div>
            <div className='md:flex md:flex-row md:px-30'>
                <CourseCards icon=".\src\assets\icon-camera.svg" title="Photography" describe="Explore critical fundamentals like lighting, composition, and focus to capture exceptional photos."/>
                <CourseCards icon=".\src\assets\icon-crypto.svg" title="Crypto" describe="All you need to know to get started investing in crypto. Go from beginner to advanced with this 54 hour course."/>
                <CourseCards icon=".\src\assets\icon-bag.svg" title="Business" describe="A step-by-step playbook to help you start, scale, and sustain your business without outside investment."/>
            </div>
